  ...
  return (
    <div className="min-h-screen relative">
      ...
      <header className="relative z-10 text-center py-16 sm:py-20">
        <h1 className="text-4xl sm:text-6xl font-bold mt-12 mb-12" style={{ color: '#36A89A' }}>Know Me !</h1>
      ...
      <footer className="bg-gray-600 py-8">
        <div className="max-w-4xl mx-auto text-center px-4">
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
            ...
            <a href="https://github.com/Egaoichi-hrk/geekcamp14" aria-label="GitHub" className="text-white hover:text-gray-600">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
